...
document.querySelector(".main").addEventListener("click", function(){
 if(!animation_in_progress){
    ...
    gsap.to(h1s[index], {
        ...
        duration:1,
        onComplete: function(){
            gsap.to(this._targets[0], {top:"100%" , duration: 0});
